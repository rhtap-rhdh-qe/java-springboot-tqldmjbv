...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/java-springboot-tqldmjbv:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/java-springboot-tqldmjbv-gitops
